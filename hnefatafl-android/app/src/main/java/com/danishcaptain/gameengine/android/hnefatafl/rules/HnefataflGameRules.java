package com.danishcaptain.gameengine.android.hnefatafl.rules;
...
import com.danishcaptain.gameengine.core.model.domain.rules.CellRule;
import com.danishcaptain.gameengine.core.model.domain.rules.EndOfGameRule;

import java.util.List;

public class HnefataflGameRules extends EndOfGameRule implements PieceUpdateListener {
    private final GameBoard board;
//    private TicTacToePiece[][] map = new TicTacToePiece[3][3];

    public HnefataflGameRules(GameBoard board, List<BoardCell> cells) {
        this.board = board;
